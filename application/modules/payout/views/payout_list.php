						...
						<div class="form-group">						
							...
							<div class="col-sm-3">
								<div class="input-group">
									<input type="text" class="form-control" autofocus name="r" <?php echo (isset($f['r'])) ? 'placeholder="'.$f['r'].'"' : 'placeholder="NIS Siswa"' ?> required>
				...
				<div class="row">
					...
					<div class="col-md-4">
						<div class="box box-primary">
							...
							<div class="box-body">
								<div class="form-group">
									<label for="dropdown">Jenis Pembayaran :</label>
